...
.var showRasterTime1 = Screen + (40 * 5) + 10 // $054a-80
.var showRasterTime2 = Screen + (40 * 5) + 13 // $054d-80
.var maxRasterTime1	= Screen + (40 * 5) + 25 // $0559-80
.var maxRasterTime2 = Screen + (40 * 5) + 28 // $055c-80
//------------------------------------------------------------------------------------------------------------------------------------------------------------
// load music
//------------------------------------------------------------------------------------------------------------------------------------------------------------
...
timer_2:									lda ras_time
											jsr convert
											sta showRasterTime1+1
											stx showRasterTime1
											lda ras_max
											jsr convert
											sta maxRasterTime1+1
											stx maxRasterTime1

// Display Decimal Values.
											ldy ras_time
											lda ascii_lo,y
											sta showRasterTime2+1
											lda ascii_hi,y
											sta showRasterTime2
											ldy ras_max
											lda ascii_lo,y
											sta maxRasterTime2+1
											lda ascii_hi,y
											sta maxRasterTime2
											rts
//------------------------------------------------------------------------------------------------------------------------------------------------------------
